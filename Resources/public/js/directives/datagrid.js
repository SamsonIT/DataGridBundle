...
angular.module('Samson.DataGrid')
    .directive('datagrid', function($locale) {
        ...
        var service = {
            ...
            transclude: true,
            scope: true,
            templateUrl: '/bundles/samsondatagrid/views/datagrid.html?version=2_3_12',
            replace: true,
            ...
            controller: function($scope, $rootScope, $templateCache, $injector, $parse, $q, $timeout, $interpolate) {
                ...
                $scope.filterTemplate = '/bundles/samsondatagrid/views/filter.html?version=2_3_12';
                $scope.paginationTemplate = '/bundles/samsondatagrid/views/pagination.html?version=2_3_12';
